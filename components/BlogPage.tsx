    ...
    <div className="pt-24 pb-20 min-h-screen bg-[#f7f5f3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="w-full overflow-x-auto no-scrollbar -mx-4 px-4 flex justify-center">
            <div className="inline-flex bg-white p-2 rounded-full shadow-2xl border border-[#e0d5c7]/30 whitespace-nowrap min-w-max">
              {[
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-6 md:px-8 py-3 md:py-4 rounded-full text-[9px] md:text-[11px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${activeTab === tab.id
